...
class url
{
    ...
    {
        $home_url = url::page('admin/dashboard');
        if (session::get('user_type') == 2) $home_url = url::page('orders/lists/0');
        else if (session::get('user_type') == 3) $home_url = url::page('categories');
