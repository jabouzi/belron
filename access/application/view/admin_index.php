...
<div id="Container_Principale_full">
    <div id="Container_Principale_960">
		...
		<div class="float_left"><a href="<?=url::page('login/storelogin'); ?>"><img src="<?=url::base()?>public/styles/images/Landing_Tonik_<?=session::get('lang')?>.jpg" width="460" height="232" alt="" /></a></div>
