...
if (is_file(url::root().'public/images/products/166x253/'.$prod->id.'.jpg'))  $product_image = base_url().'public/images/products/166x253/'.$prod->id.'.jpg';
?>  
<div id="Container_Principale_full">
    ...
    <div id="Collone2">
        <div id="Panier">   
            ...
            <div class="Boite">
            <form action="/wishlist/confirm" method="post" id="wish_form">
                <ul id="wish_list">                    
                </ul>
