            ...
            <tbody>
                <?foreach ($categories as $key => $category):?>
                    ...
                    <tr class="<?=$tr_class?>">
                        ...
                        <td><?=$category->image_file?></td>               
                        <?$active = 'Not active'; if ($category->active):?>
                            <?$active = 'Active';?>
                        <?endif?>
                        <td><?=$active?></td>   
                        <td><a href="<?=base_url()."productsmanager/edit_category/{$category->id}/"?>"><?=gettext("Edit")?></a></td>
                    </tr>
                <?endforeach?>
            </tbody>
        </table>
...
<div class="modal" id="add-category">
    ...
    <form id="edit_product" method="post" action="<?=base_url()."productsmanager/add_category/"; ?>">        
        <div>                
