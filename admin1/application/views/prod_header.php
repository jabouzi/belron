...
<div id="header_full">
    <div id="header_960">
        ...
        <div id="header_menu">         
            ...
            <a href="<?=base_url().'productsmanager/add'?>"><?=gettext("Add product")?></a>            
            <a href="<?=base_url().'productsmanager/lists'?>"><?=gettext("Products list")?></a>       
            <a href="<?=base_url().'productsmanager/categories'?>"><?=gettext("Categories")?></a> 
