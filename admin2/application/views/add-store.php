<div id="Container_Principale_full">
    <div id="Container_Principale_960">
        ...
        <form id="edit_store" method="post" action="<?=base_url()."storesmanager/insert/"; ?>">
            <div>            
            <?$provinces = provinces();?>
            ...
            <input type="button" class="commande" name="submit_update" value="<?=gettext("Save store infos")?>" onclick="add_update_store()"/>
        </form>
    </div>
</div>
