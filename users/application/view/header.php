...
<div id="header_full">
    <div id="header_960">
        ...
        <div id="header_menu">                          
                ...
                <a href="<?=url::page('usersmanager/logout')?>"><?=gettext("Logout")?></a>
                <a href="<?=url::page('usersmanager/add')?>"><?=gettext("Add")?></a>            
                <a href="<?=url::page('usersmanager/lists')?>"><?=gettext("List")?></a>       
                <? endif?>     
            <form name="form" method="post" action="<?=url::page('usersmanager/change_language')?>">
            ...
            <?if ($redirect_url[1] != 'usersmanager/change_language'):?>
