...
<div id="header_full">
    <div id="header_960">
        ...
        <div id="header_menu">                          
                ...
                <a href="<?=url::page('storesmanager/logout')?>"><?=gettext("Logout")?></a>
                <a href="<?=url::page('storesmanager/add')?>"><?=gettext("Add")?></a>            
                <a href="<?=url::page('storesmanager/lists')?>"><?=gettext("List")?></a>       
                <? endif?>     
            <form name="form" method="post" action="<?=url::page('storesmanager/change_language')?>">
            ...
            <?if ($redirect_url[1] != 'storesmanager/change_language'):?>
